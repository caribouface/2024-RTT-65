...
. Composition = we have all the information we THINK we will need for a student
 */


public class Student {
    //Data fields / attributes / variables that will HOLD information about a student:
    ...
    public static String schoolName; //Done not depend on the object

    /*
    Constructor - Scanner input = new Scanner(System.in)
    Same name as the class, a special method used to create Student objects
    We can have different flavors of it (what do we mean by the FLAVORS)
    Does not have a return type
    It is usually public because we need to access it to create the objects
     */
    public Student(String justice, String a, String s, int i, int i1, String string){ //no argument, default constructor
        firstName = "";
        middleName = "";
        lastName = "";
        age = 0;
    ...
    public Student(String firstName, String middleName, String lastName, int age,
        ...
        /*
        . take the values entered and make them the values of the class variables
